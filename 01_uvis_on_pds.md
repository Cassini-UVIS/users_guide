...
6. Figure {ref}`fig:phoebe-dayside` can be generated by using the data at sample number 15. 
...
4) Figure 1.3 can be generated by using the Enceladus data. 
Note that the users will need to sum all spatial elements (lines) of the corresponding samples in order to obtain the total raw counts as shown in Figure 1.3.


Figure 1.3: Cassini UVIS observation during the 2005 Enceladus occultation event. 
