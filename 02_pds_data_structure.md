...
:::{figure} figures/fig_2.2.*
:label: "fig:example-wavelength-image"
:alt: image at one wavelength
An image at one wavelength
:::

:::{figure} figures/fig_2.3.*
...
:::{figure} figures/fig_2.4.*
:label: "fig:example-jupiter-image"
:alt: series of spectra
...
:::{figure} figures/fig_2.6.*
:label: "fig:pds-windowed-data"
:alt: PDS data for windowed data
